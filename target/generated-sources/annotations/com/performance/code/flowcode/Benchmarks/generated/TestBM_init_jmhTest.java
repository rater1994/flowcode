...
import com.performance.code.flowcode.Benchmarks.generated.TestBM_jmhType;
public final class TestBM_init_jmhTest {
    ...
    public BenchmarkTaskResult init_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            TestBM_jmhType l_testbm0_0 = _jmh_tryInit_f_testbm0_0(control);
    ...
    TestBM_jmhType f_testbm0_0;
    
    TestBM_jmhType _jmh_tryInit_f_testbm0_0(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        TestBM_jmhType val = f_testbm0_0;
        if (val == null) {
            val = new TestBM_jmhType();
            f_testbm0_0 = val;
        }
        return val;
    }
